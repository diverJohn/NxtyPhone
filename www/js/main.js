...
//		 	this.showAlert("Registration mode not allowed...", "Bluetooth not connected.");
	...
	renderHomeView: function() 
	{
		...
		var myRegButton     = isRegistered   ? "<button id='reg_button_id' type='button' class='mybutton' touchstart='HandleButtonDown(this)' touchend='HandleButtonUp(this)' onclick='app.handleRegKey()'></button>" : "<button id='reg_button_id' type='button' class='mybutton' onmousedown='HandleButtonDown(this)' onmouseup='HandleButtonUp(this)' onclick='app.handleRegKey()'><img src='img/button_Register.png' /></button>";
		
		var myHtml = 
			"<img src='img/header_main.png' width='100%' />" +
			myBluetoothIcon +
            myRegIcon +
   			"<button type='button' class='mybutton' touchstart='HandleButtonDown(this)' touchend='HandleButtonUp(this)' onclick='app.handleSwUpdateKey()'><img src='img/button_SwUpdate.png' /></button>" +
